            ...
            <div className="div">
              ...
              <div className="d-flex justify-content-between px-2">
                <FaFacebook
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.facebook.com/profile.php?id=100004735304922",
                      "_blank"
                    )
                  }
                />
                <FaMailBulk
                  ...
                  onClick={() =>
                    window.open(
                      "mailto:ovisarkareceian@gmail.com?subject=Subject&body=Message",
                      "_blank"
                    )
                  }
                />
                ...
                <FaGithub
                  className="footer-icons"
                  onClick={() =>
                    window.open("https://github.com/OviSarkar62", "_blank")
                  }
                />
              </div>
